...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('tasklist_task', (
            ...
            ('list', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tasklist.TaskList'])),
            ('completed', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('due_date', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal('tasklist', ['Task'])

        # Adding model 'TaskList'
        db.create_table('tasklist_tasklist', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True, blank=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ...
        db.send_create_signal('tasklist', ['TaskList'])


    def backwards(self, orm):
        # Deleting model 'Task'
        db.delete_table('tasklist_task')

        # Deleting model 'TaskList'
        db.delete_table('tasklist_tasklist')
