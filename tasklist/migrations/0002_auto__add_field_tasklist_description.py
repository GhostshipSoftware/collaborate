...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TaskList.description'
        db.add_column('tasklist_tasklist', 'description',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TaskList.description'
        db.delete_column('tasklist_tasklist', 'description')
    ...
    models = {
        ...
        'tasklist.task': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'list': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['tasklist.TaskList']"}),
