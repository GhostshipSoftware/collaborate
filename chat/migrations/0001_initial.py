...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('chat_message', (
            ...
            ('channel', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['chat.Channel'])),
        ))
        db.send_create_signal('chat', ['Message'])

        # Adding model 'Channel'
        db.create_table('chat_channel', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('chat', ['Channel'])
    ...
    models = {
        ...
        'chat.message': {
            ...
            'channel': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['chat.Channel']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
